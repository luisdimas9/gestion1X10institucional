import { getInstitucion, getFuncionario, agregarUnopordiez, getCargaUnopordiez, aprobarCarga} from './unopordiez.controller.js';
import {updateTotalCarga} from './unopordiez.controller.js';

$(document).ready(() => {
  $("#crud-unopordiez").hide();
  getInstitucion();  
  
  //setInterval(updateTotalCarga, 10 * 1000);
